    ...
    <g className = "g-ants">
      ...
      <use xlinkHref="#s-text" className="text-copy"></use>
            ...
            <div className="contenedorVideo">
                ...
                <div>
                <iframe  src="https://wordwall.net/es/embed/932b6e837b1a489cb52496bd0769709f?themeId=1&templateId=5&fontStackId=0" width="500" height="380"  allowfullscreen="true"></iframe>
