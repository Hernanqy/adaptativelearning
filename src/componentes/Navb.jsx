...
<nav className="bg-transparent navprincipal dark:bg-gray-900">
  ...
  <div className="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-cta">
    <ul className="flex flex-col font-medium p-4 md:p-0 mt-4  rounded-lg bg-transparent md:flex-row md:space-x-8 md:mt-0 md:border-0  ">
      ...
      <li>
        <a href="./Modulo1" className="grow block py-2 pl-3 pr-4 text-white rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 md:dark:hover:text-blue-500 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Desafios</a>
      </li>
      <li>
